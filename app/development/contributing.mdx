...
> **Note:** For AI-assisted development workflow, see the [Agent Protocol](/development/agent-protocol) guide which explains how Claude Code and ChatGPT collaborate on code development.
