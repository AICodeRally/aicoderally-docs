...
**Learn More:**
- [Application Architecture](/architecture) - 4-layer app structure
- [Unified System Architecture](/architecture/unified) - Complete ecosystem (Rally Stack + Rally AI + Agent Protocol)
- [Rally AI](/tools/rally-ai) - Multi-AI orchestrator for architecture and design
- [Agent Protocol](/development/agent-protocol) - AI agent coordination workflow
