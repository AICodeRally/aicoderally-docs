...
4. **Add These Variables:**
   ...
   | `SUPABASE_ACCESS_TOKEN` | `xxxxx` (your token) | Production, Preview, Development |
...
# 3. Supabase Token (from https://supabase.com/dashboard/account/tokens)
SUPABASE_ACCESS_TOKEN=sbp_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx

# 4. Admin Password (choose your own secure password)
...
- Fetches database metrics from Supabase
- Shows table counts, API requests, regions
- Without it: Shows fallback databases (studio-prod, shared-prod)
...
- ✅ All tokens are stored securely in Vercel
- ✅ Tokens are never exposed to the browser
- ✅ All API calls run server-side as serverless functions
- ✅ Admin password is client-side but session-based
...
- 🔗 Vercel Dashboard: https://vercel.com/aicoderally/aicoderally-website
- 🔗 GitHub Tokens: https://github.com/settings/tokens
- 🔗 Vercel Tokens: https://vercel.com/account/tokens
- 🔗 Supabase Tokens: https://supabase.com/dashboard/account/tokens
- 🔗 Admin Dashboard: https://aicoderally.com/admin/health
...
🚀 Your dashboard will show real-time data once tokens are added!
