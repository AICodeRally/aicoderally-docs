...
```mermaid
graph TD
    A["📱 Client Applications<br/>Studio, Website, Mobile, APIs"]
    B["🎯 RallyAIRouter<br/>Request Orchestrator"]

    C["💰 Budget Service<br/>4-Level Hierarchy<br/>Project > Plan > User > Global"]
    D["🔤 Prompt Selector<br/>A/B Testing<br/>Auto-Winner Promotion"]
    E["💾 Cache Service<br/>Exact + Semantic<br/>30-50% Savings"]
    F["🤖 Provider Selector<br/>3-Tier Models<br/>Fast/Balanced/Powerful"]

    G["🔀 Provider Selection Engine"]

    H["🧠 Anthropic Claude<br/>Technical Analysis"]
    I["🔥 OpenAI GPT-4<br/>Sprint Planning"]
    J["✨ Google Gemini<br/>Business Validation"]
    K["⚡ Fallback Provider"]

    L["📊 Logging & Metrics"]
    M["🗄️ PostgreSQL<br/>Cache, Budgets, Logs"]
