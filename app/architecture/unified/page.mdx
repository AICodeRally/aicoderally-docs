...
- `SYSTEM.md` → architectural rules
- `CURRENT_TASK.md` → what the agents should focus on
- `AGENT_MEMORY.md` → long-term patterns, decisions, preferences
...
AICodeRally is a product + franchise.

### Three Tiers

**Studio** – Physical franchise, full-production apps
**Edge** – SMB AI app builder
**Summit** – Enterprise AI/LLM engagements

### Qualification Funnel

1. Pre-test (online)
2. Build challenge (using Rally Stack)
3. Interview
4. Certification
5. Onboarding
...
Agents validate their modules.
Rally AI ensures high-quality code.
...
**Learn More:**
- [Franchise Documentation](/franchise) - Complete franchise guide
...
| **Studio** | Franchise offering (one idea → one app) |
...
- [Architecture 3.0](/architecture) - Four-layer application architecture (Modules → Studio → Edge → Summit)
...
**📄 [`UNIFIED_ARCHITECTURE.md`](https://github.com/AICodeRally/aicoderally-stack/blob/master/UNIFIED_ARCHITECTURE.md)**
